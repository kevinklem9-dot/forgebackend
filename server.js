...
<!-- HEADER -->
<tr><td bgcolor="#0a0a0a" style="padding:36px 24px 32px;text-align:center;background:#0a0a0a">
...
<!-- HERO -->
<tr><td bgcolor="#ffffff" style="padding:36px 24px 28px;background:#ffffff">
  <div style="font-family:'Courier New',Courier,monospace;font-size:40px;font-weight:700;color:#0a0a0a;letter-spacing:1px;line-height:1;margin-bottom:10px">Welcome, ${name}.</div>
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:20px;color:#0a0a0a;font-weight:600;margin-bottom:12px">Let's build something.</div>
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:15px;color:#555555;line-height:1.7"><span style="font-family:'Courier New',Courier,monospace;background:#e8ff3d;color:#000000;padding:1px 6px;border-radius:4px;font-weight:600">7 days</span> of full access. Here's how to use every one.</div>
</td></tr>

<!-- STEPS CARD -->
<tr><td bgcolor="#ffffff" style="padding:0 24px 28px;background:#ffffff">
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#f7f7f7" style="background:#f7f7f7;border:1px solid #eeeeee;border-radius:16px">

  <tr><td style="padding:22px 24px;border-bottom:1px solid #eeeeee">
    <div style="font-family:'Courier New',Courier,monospace;font-size:10px;color:#e8ff3d;background:#0a0a0a;display:inline-block;padding:2px 8px;border-radius:4px;letter-spacing:2px;margin-bottom:8px">01</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:15px;font-weight:700;color:#0a0a0a;margin-bottom:8px">Finish your onboarding</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;color:#444444;line-height:1.7">If you haven't completed your profile yet — do it now. Your sport, your schedule, your goals, your injury history. The more honest your answers, the sharper your programme. This is the step most people rush. <strong style="color:#0a0a0a">Don't.</strong></div>
  </td></tr>

  <tr><td style="padding:22px 24px;border-bottom:1px solid #eeeeee">
    <div style="font-family:'Courier New',Courier,monospace;font-size:10px;color:#e8ff3d;background:#0a0a0a;display:inline-block;padding:2px 8px;border-radius:4px;letter-spacing:2px;margin-bottom:8px">02</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:15px;font-weight:700;color:#0a0a0a;margin-bottom:8px">Talk to your coach</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;color:#444444;line-height:1.7">Your AI coach is live the moment onboarding is done. Ask it anything — form, nutrition, when to add weight, how to adjust your plan around an injury. It reads your data and gives you a real answer. <strong style="color:#0a0a0a">Use it.</strong></div>
  </td></tr>

  <tr><td style="padding:22px 24px;border-bottom:1px solid #eeeeee">
    <div style="font-family:'Courier New',Courier,monospace;font-size:10px;color:#e8ff3d;background:#0a0a0a;display:inline-block;padding:2px 8px;border-radius:4px;letter-spacing:2px;margin-bottom:8px">03</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:15px;font-weight:700;color:#0a0a0a;margin-bottom:8px">Log every session</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;color:#444444;line-height:1.7">Every set you log makes your coach smarter. The programme adapts based on what your data actually shows — not what it guessed about you on day one. <strong style="color:#0a0a0a">Log everything. Miss nothing.</strong></div>
  </td></tr>

  <tr><td style="padding:22px 24px">
    <div style="font-family:'Courier New',Courier,monospace;font-size:10px;color:#e8ff3d;background:#0a0a0a;display:inline-block;padding:2px 8px;border-radius:4px;letter-spacing:2px;margin-bottom:8px">04</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:15px;font-weight:700;color:#0a0a0a;margin-bottom:8px">Set a daily reminder</div>
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;color:#444444;line-height:1.7">Go to <span style="font-family:'Courier New',Courier,monospace;background:#0a0a0a;color:#e8ff3d;padding:1px 6px;border-radius:4px;font-size:12px">Account → Workout Reminder</span> and set a time. One push notification a day. The sessions you almost skip are the ones that matter most.</div>
  </td></tr>
...
<tr><td bgcolor="#ffffff" style="padding:0 24px 28px;background:#ffffff">
  ...
  <tr><td bgcolor="#e8ff3d" style="background:#e8ff3d;border-radius:10px;text-align:center;padding:18px">
  ...
  <div style="text-align:center;margin-top:14px;font-family:'Courier New',Courier,monospace;font-size:10px;color:#999999;letter-spacing:1.5px;text-transform:uppercase">7-day free trial &nbsp;·&nbsp; no card charged &nbsp;·&nbsp; cancel anytime</div>
</td></tr>

<!-- FOOTER -->
<tr><td bgcolor="#0a0a0a" style="padding:24px;background:#0a0a0a;text-align:center">
  <div style="font-family:'Courier New',Courier,monospace;font-size:10px;color:#666666;letter-spacing:2px;text-transform:uppercase;margin-bottom:6px">FORGE · AI Performance Coach</div>
  ...
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:11px;color:#444444">You received this because you signed up for FORGE.</div>
</td></tr>
